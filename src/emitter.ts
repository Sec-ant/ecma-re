...
function needsCharClassEscape(cp: number, useVFlag: boolean): boolean {
  switch (cp) {
    ...
    case 0x2d:
      return true;
    default:
      return useVFlag && needsVModeCharClassEscape(cp);
  }
}

function needsVModeCharClassEscape(cp: number): boolean {
  switch (cp) {
    // ECMAScript UnicodeSets syntax characters.
    case 0x28:
    case 0x29:
    case 0x5b:
    case 0x7b:
    ...
    case 0x2f:
      return true;
    // Characters that form reserved double punctuators in UnicodeSets mode.
    case 0x21:
    case 0x23:
    case 0x24:
    case 0x25:
...
function emitCharClassMember(elem: CharClassMember, useVFlag: boolean): string {
  switch (elem.type) {
    ...
    case "nestedClass":
      return emitCharClass(elem.node, useVFlag);
  }
}
